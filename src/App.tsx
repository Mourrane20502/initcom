...
function App() {
  ...
  return (
     <div className="scroll-smooth">
      ...
      {/*Qui sommes nous */}
      <section id="qui-sommes-nous" className="flex flex-col items-center w-full px-6 py-12 scroll-m-16 md:flex-row justify-evenly">
  {/* Left Image */}
  <img
    src={LeftSidePicture}
    alt="left side"
  ...
  <div className="flex flex-col items-center justify-center max-w-lg gap-2 text-center md:text-left">
    ...
    <p className="mb-6 text-lg leading-relaxed text-gray-700">
      <span className="font-bold text-rose-700">INITCOM</span>  est une agence de communication basée au Maroc, spécialisée dans la création de solutions innovantes et sur mesure pour ses clients.
...
Notre équipe d'experts passionnés excelle dans divers domaines, notamment le marketing événementiel, le marketing opérationnel, le trade marketing et le retail marketing.
 ...
 {/*Nos Services */}
 <section id="services" className="w-full px-6 py-20 bg-gradient-to-b from-white to-rose-100">
 ...
 <section id="partenaires" className="w-full py-16 overflow-hidden scroll-m-[70px] bg-gradient-to-r from-rose-200 to-white">
    ...
    <div className="flex gap-8 px-8 animate-scroll whitespace-nowrap">
      {partners.map((partner) => (
        ...
        >
          ...
          />
          <p className="mt-2 text-sm font-semibold text-gray-700">{partner.name}</p>
        </div>
      ))}
    </div>
  </div>
      ...
      <div className="grid items-center grid-cols-1 gap-12 mx-auto max-w-7xl lg:grid-cols-2">
        ...
        <div className="p-8 bg-white shadow-lg rounded-2xl">
          <form className="flex flex-col gap-6">
            ...
            <button onClick={()=>successToast("Message Envoyé Avec succès!")}
              type="submit"
